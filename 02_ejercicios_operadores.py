...
print('El numero', str(7), 'es mi numero favorito')
...
alfabético.
"""
print( 'apple' < 'banana') # La palabra 'apple' tiene mayor orden, ya que a es mayor que b en la ordenación alfabética por ASCII
print( 'apple' > 'banana')
...
print( not(15 > 20)) # El resultado es True, ya que 15 no es mayor que 20 y al colocarle el not invierte el resultado.

"""
10. 
Combina operadores aritméticos y lógicos: Verifica 
